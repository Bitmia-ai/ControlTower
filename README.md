<div align="center">
  ...
  <p>
    <a href="https://github.com/Bitmia-ai/ControlTower/actions/workflows/test.yml">
      <img src="https://github.com/Bitmia-ai/ControlTower/actions/workflows/test.yml/badge.svg?branch=main" alt="CI status" />
    </a>
  ...
  <a href=".github/assets/home-light.png">
    <picture>
      <source media="(prefers-color-scheme: dark)" srcset=".github/assets/home-dark.png" />
      <img src=".github/assets/home-light.png" alt="Control Tower home page — project cards showing phase and active task" width="100%" />
    </picture>
  </a>
</div>
...
<table>
  <tr>
    ...
    <td align="center"><strong>Tasks</strong><br/>backlog with priority, status, and recent ships</td>
  </tr>
  <tr>
    <td>
      <a href=".github/assets/project-light.png">
        <picture>
          <source media="(prefers-color-scheme: dark)" srcset=".github/assets/project-dark.png" />
          <img src=".github/assets/project-light.png" alt="Mission control page" />
        </picture>
      </a>
    </td>
    <td>
      <a href=".github/assets/tasks-light.png">
        <picture>
          <source media="(prefers-color-scheme: dark)" srcset=".github/assets/tasks-dark.png" />
          <img src=".github/assets/tasks-light.png" alt="Tasks page" />
        </picture>
      </a>
    </td>
  </tr>
...
The dashboard never writes to `.redeye/*` on its own — only when you click something. Everything stays in plain markdown files; you can mix and match with the RedEye slash commands inside Claude Code.

## See it in action

[**WeatherCLI-Sample**](https://github.com/Bitmia-ai/WeatherCLI-Sample) is a small TypeScript weather CLI built end-to-end by RedEye driven through Control Tower — every commit, every spec, every retry-loop is in the repo's `.redeye/` history. Clone it, register it as a project here, and the dashboard will load all 44 shipped tasks, per-task costs, and the full session transcripts.

```bash
git clone https://github.com/Bitmia-ai/WeatherCLI-Sample.git ~/WeatherCLI-Sample
# Add it from the home page → "Add Project" → /Users/<you>/WeatherCLI-Sample
```

Useful as a reference for what a clean RedEye-driven project looks like, and as a smoke-test that Control Tower correctly hydrates a freshly-cloned `.redeye/` tree.
...
- **Trust your projects.** Control Tower spawns Claude Code as your user with `--dangerously-skip-permissions`. Don't add projects you don't trust.

## How It's Different

You can drive RedEye directly from Claude Code with `/redeye:start`. So why use this?
...
If you only ever run one project from one terminal, the slash commands are fine. Control Tower starts to pay off the moment you have two.
...
**Does it replace the RedEye slash commands?**
...
- **Control Tower Cloud** — coordination-only SaaS so you can watch sessions, answer questions, and steer from anywhere without exposing your machine.
