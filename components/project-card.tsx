...
import { getPhaseColors, getPhaseLabel, normalizePhase } from "@/lib/redeye-types";
...
export function ProjectCard({ project, index, onToggle, onDelete }: ProjectCardProps) {
  ...
  const noTasks = !project.running && phaseKey === "HARDEN";
  ...
  const phaseColor = getPhaseColors(project.phase);
