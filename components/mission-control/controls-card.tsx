      ...
      <div className="flex flex-col gap-3">
        <div className="grid grid-cols-2 gap-2">
          {!running ? (
            <button
              onClick={onStart}
              className="col-span-2 min-h-[44px] inline-flex items-center justify-center gap-1.5 px-3 py-2 text-sm font-medium bg-green-700 hover:bg-green-600 text-white rounded-md transition"
            >
              <Play size={15} />
              Start
            </button>
            ...
            <>
              <div ref={dropdownRef} className="relative">
                <button
                  ...
                  className="w-full min-h-[44px] inline-flex items-center justify-center gap-1.5 px-3 py-2 text-sm font-medium bg-red-700 hover:bg-red-600 disabled:bg-red-900 disabled:opacity-70 disabled:cursor-not-allowed text-white rounded-md transition"
                >
                  <Square size={15} />
                  {stopLabel}
                </button>
                <button
                  ...
                  className="absolute right-1 top-1/2 -translate-y-1/2 min-h-[36px] w-7 text-sm font-medium text-white/80 hover:text-white hover:bg-red-600 disabled:opacity-50 disabled:cursor-not-allowed rounded transition flex items-center justify-center"
                >
                  <ChevronDown size={14} />
                </button>
              ...
              {stalled ? (
                <button
                  onClick={onRestart}
                  disabled={forceStopping}
                  className="min-h-[44px] inline-flex items-center justify-center gap-1.5 px-3 py-2 text-sm font-medium bg-amber-600 hover:bg-amber-500 disabled:opacity-60 disabled:cursor-not-allowed text-white rounded-md transition"
                >
                  <RotateCcw size={15} />
                  Restart
                </button>
                ...
                <button
                  ...
                  className="min-h-[44px] inline-flex items-center justify-center gap-1.5 px-3 py-2 text-sm font-medium bg-gray-200 dark:bg-zinc-700 hover:bg-gray-300 dark:hover:bg-zinc-600 disabled:opacity-60 disabled:cursor-not-allowed text-gray-700 dark:text-zinc-200 rounded-md transition"
                >
                  <Pause size={15} />
                  {pauseLabel}
                </button>
        ...
        <div className="border-t border-gray-100 dark:border-zinc-800 pt-3 mt-1 grid grid-cols-2 gap-2">
          <button
            onClick={onSteer}
            className="min-h-[44px] inline-flex items-center justify-center gap-1.5 px-3 py-2 text-sm font-medium bg-gray-50 dark:bg-zinc-800 hover:bg-gray-100 dark:hover:bg-zinc-700 text-gray-700 dark:text-zinc-300 rounded-md border border-gray-200 dark:border-zinc-700 transition"
          >
            <Navigation size={15} />
            Steer
          </button>
          <button
            onClick={onAddTask}
            aria-label="Add task"
            className="min-h-[44px] inline-flex items-center justify-center gap-1.5 px-3 py-2 text-sm font-medium bg-indigo-50 dark:bg-indigo-950/40 hover:bg-indigo-100 dark:hover:bg-indigo-900/40 text-indigo-700 dark:text-indigo-300 rounded-md border border-indigo-200 dark:border-indigo-800 transition"
          >
            <PlusCircle size={14} />
            Add Task
          </button>
