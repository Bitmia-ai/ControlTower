...
// Cost analytics sparkline (T051) was replaced by the CostTrendChart
// projection chart (T117). The cost-card no longer renders a SparklineChart
// at all. Skipping to avoid false-positive regressions.
// See e2e/cost-forecasting.spec.ts for the current chart's test coverage.
test.describe.skip("Cost analytics sparkline (T051 — retired)", () => {
